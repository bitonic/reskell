...
Most of these functions accept a form in the 'TemplateM' form -
probably generated by 'eitherHappstackForm' - and return a response.
...
userPage user = render $ template
                ...
                , [ <p><b>Member since:</b>
                  ...
                  , <p><b>Karma: </b> <% show (uKarma user) %></p>
                  ] ++ (if null (uAbout user)
                        then []
